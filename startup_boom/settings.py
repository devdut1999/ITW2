"""
Django settings for startup_boom project.
...
SECRET_KEY = 'g&v%4kce@-*!9)!z0g6n-3!w*_yd^zq103^m28b-0bs!=!*z$%'
...
ROOT_URLCONF = 'startup_boom.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['startup_boom/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'startup_boom.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'startup_boom/static')
]
